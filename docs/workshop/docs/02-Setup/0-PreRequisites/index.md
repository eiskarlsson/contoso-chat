...
=== "Self-Guided"
    ...
    ??? info "3. What You Will Take Away (expand to view)"   
        ...
        1. A personal copy of the [Contoso Chat](https://aka.ms/LIMBODATINGCHAT/contoso-chat) repository in your GitHub profile. This contains all the materials you need to reproduce the workshop on your own later (e.g., as a _Self-Guided_ session).
